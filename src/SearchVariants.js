  ...
  render() {
    ...
    return (
      <span>
        ...
        <ListVariants baseurl={this.props.route.baseurl} variantSetId={this.props.params.variantSetId} referenceName={this.state.refName} start={this.state.start} end={this.state.end} pageSize={this.state.pageSize} currPage={this.state.currPage} />
      </span>
    )
  }
}
...
export class ListVariants extends Component {
  ...
  render() {
    ...
    return (
      <div>
      <div>Variants (page: {this.state.currPage})</div>
